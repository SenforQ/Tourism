      ...
      body: Padding(
        ...
        child: ListView(
          children: const [
            ...
            SizedBox(height: 16),
            Text('5. Intellectual Property', style: _titleStyle),
            Text(
              'All content in the app is the property of the company or its licensors.',
              style: _contentStyle,
            ),
            SizedBox(height: 16),
            Text('6. Termination', style: _titleStyle),
            Text(
              'We may terminate or suspend your access to the app at any time, without notice.',
              style: _contentStyle,
            ),
            SizedBox(height: 16),
            Text('7. Disclaimer of Warranties', style: _titleStyle),
            Text(
              'The app is provided on an "as is" and "as available" basis.',
              style: _contentStyle,
            ),
            SizedBox(height: 16),
            Text('8. Limitation of Liability', style: _titleStyle),
            Text(
              'We are not liable for any damages arising from your use of the app.',
              style: _contentStyle,
            ),
            SizedBox(height: 16),
            Text('9. Governing Law', style: _titleStyle),
            Text(
              'These terms are governed by the laws of the applicable jurisdiction.',
              style: _contentStyle,
            ),
            SizedBox(height: 16),
            Text('10. Contact Information', style: _titleStyle),
            Text(
              'For any questions about these terms, please contact us.',
              style: _contentStyle,
            ),
            SizedBox(height: 16),
            Text('11. Entire Agreement', style: _titleStyle),
            Text(
